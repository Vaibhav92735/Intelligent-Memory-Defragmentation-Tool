...
FileSystem::FileSystem(Config *setting) : rootDirectory(new Directory("/", NULL , setting)), workingDirectory(rootDirectory) {
	con = setting ;
 }
...
void FileSystem::defragmenting(FileSystem &fs_src, int rows, int cols)
{	
