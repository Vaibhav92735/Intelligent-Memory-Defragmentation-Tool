...
fs: bin/Config.o  bin/StringTools.o bin/Environment.o bin/main.o bin/Commands.o bin/FileSystem.o bin/Files.o
	@echo 'Building target: fs'
	@echo 'Invoking: C++ Linker'
	g++ -o bin/fs bin/Config.o bin/StringTools.o bin/Environment.o bin/main.o bin/Commands.o bin/FileSystem.o bin/Files.o
	@echo 'Finished building target: fs'
	@echo ' '

# Depends on the source and header files
bin/Config.o: src/Config.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/Config.o src/Config.cpp
